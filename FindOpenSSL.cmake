...
IF(WIN32 AND MSVC)
   ...
   FIND_LIBRARY(SSL_EAY_DEBUG NAMES ssleay32MDd ssl crypto ssleay32)
   FIND_LIBRARY(SSL_EAY_RELEASE NAMES ssleay32MD ssl crypto ssleay32)
   FIND_LIBRARY(SSL_CRYPTO NAMES crypto)
...
ELSE(WIN32 AND MSVC)
   ...
   FIND_LIBRARY(OPENSSL_LIBRARIES NAMES ssl crypto ssleay32 ssleay32MD )
   FIND_LIBRARY(OPENSSL_LIBRARIES NAMES ssl crypto ssleay32 ssleay32MD )
...
IF (OPENSSL_FOUND)
   IF (NOT OpenSSL_FIND_QUIETLY)
           MESSAGE(STATUS "Found OpenSSL: ${OPENSSL_LIBRARIES} ${OPENSSL_CRYPTO_LIBRARIES}")
