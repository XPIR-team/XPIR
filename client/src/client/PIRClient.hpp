...
class PIRClientSimple
{
  private:
    ...
    void uploadWorker(PIRQueryGenerator& queryGen);
    void downloadWorker(PIRReplyExtraction& replyExt);
    void sendPirParams();
    void rcvPirParams();
