...
char* NFLLWE::encrypt(unsigned int ui, unsigned int d)
{
	...
	{
		std::cerr << "The given unsigned int does not fit in " << publicParams.getAbsorptionBitsize() << " bits"<< std::endl;
...
long NFLLWE::setandgetAbsBitPerCiphertext(unsigned int rec_lvl, unsigned int elt_nbr)
{
